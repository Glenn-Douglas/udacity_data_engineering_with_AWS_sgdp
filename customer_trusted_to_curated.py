...
from myDataSource
'''
DistinctCustomers_node1780247399157 = sparkSqlQuery(glueContext, query = SqlQuery2710, mapping = {"myDataSource":Joincustomertrustedtoaccelerometerlanding_node1780246672564}, transformation_ctx = "DistinctCustomers_node1780247399157")
